...
<html lang="en">
<head>
	<title>Supplier Login System</title>
...
<body>
	...
	<form method="post" action="supplierlogin.php">
		...
		<div class="input-group">
			<button type="submit" name="slogin" class="btn"  style="padding: 10px;
	font-size: 15px;
	color: #0036c3;
	background: #48caff;
	border: none;
	border-radius: 5px;">Login</button>
		...
		<p>
			Not a Supplier Yet? <a href="supplierregister.php">Sign Up</a> 
		</p>
