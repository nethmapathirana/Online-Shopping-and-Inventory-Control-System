...
<body>
	...
	<form method="post" action="customerchangepassword.php">
		...
		<div class="input-group">
			<button type="submit" name="cpasswordchange" class="btn" style="padding: 10px;font-size: 15px;color: #0036c3;background: #48caff;border: none;border-radius: 5px;">Change Password</button>
		</div>
		<p>
			Return to Customer Home Page? <a href="customerhome.php">Home</a>
		</p>
	</form>
</body>
</html>