...
<html lang="en">
<head>
	<title>Supplier Password Change</title>
...
<body>
	<div class="header" style="width: 30%;margin:  50px auto 0px;color: #0036c3;background: #48caff;text-align: center;border: 1px solid #B0C4DE;border-bottom: none;border-radius: 10px 10px 0px 0px;padding:  20px;">
		<h2>Supplier Password Change</h2>
	</div>
	<form method="post" action="supplierchangepassword.php">
		...
		<div class="input-group">
			<button type="submit" name="spasswordchange" class="btn" style="padding: 10px;font-size: 15px;color: #0036c3;background: #48caff;border: none;border-radius: 5px;">Change Password</button>
		</div>
		<p>
			Return to Supplier Home Page? <a href="supplierhome.php">Home</a>
		</p>
	</form>
</body>
</html>