...
<body>
	...
	<form method="post" action="newintermediate2.php">
		

		<p>Would you like to add another item?</p>
		
		<div>
		<button type="submit" name="newsupplieritemintermediateyes" class="btn"  style="padding: 10px;
	font-size: 15px;
	color: #0036c3;
	background: #48caff;
	border: none;
	...
	<button type="submit" name="newsupplieritemintermediateno" class="btn"  style="padding: 10px;
	font-size: 15px;
	color: #0036c3;
	background: #48caff;
	border: none;
